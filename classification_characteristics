...
#Normalization
X = assignment[['Religiosity', 'Diversity', 'Income', "Bachelor's"]]
...
print("KNN Accuracy for 2 Neighbors:", acc2)
...
print(svm_conf)
sns.heatmap(svm_conf, annot=True, fmt="d", cmap="GnBu")
plt.title("Confusion Matrix")
plt.show()
...
print(rf_conf)
sns.heatmap(rf_conf, annot=True, fmt="d", cmap="OrRd")
plt.title("Confusion Matrix")
plt.show()
...
print(log_reg_tab)
sns.heatmap(log_reg_tab, annot=True, fmt="d", cmap="YlGn")
plt.title("Confusion Matrix")
plt.show()
